...
export class LancamentosPesquisaComponent implements OnInit {
  ...
  /**
   * Realiza a pesquisa dos lancamentos paginado de acordo com os filtros passados.
   * 
   * @param pagina 
   */
  pesquisar(pagina = 0) {
  ...
  /**
   * Abre o popup de confirmação de exclusão do lancamento.
   * 
   * @param lancamento 
   */
  ...
  /**
   * Exclui um lancamento de acordo com seu código.
   * 
   * @param lancamento 
   */
